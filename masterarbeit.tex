...
\chapter{Results}
	...
	\subsection{Simple Cluster-Based Scrambling}\label{sec:r_pe_ss}
	    ...
	    (with two-tailed \textit{p} = \py{"{:.1e}".format(ttest_ind(data_ss1[(data_ss1['scrambling'] == 0) & (data_ss1['intensity'] == 40)]['RT'], data_ss1[(data_ss1['scrambling'] == 6)]['RT'])[1])}).
	    ...
	    (two-tailed \textit{p} = \py{"{:.1e}".format(ttest_ind(data_ss1[(data_ss1['scrambling'] == 0) & (data_ss1['intensity'] == 100)]['RT'], data_ss1[(data_ss1['scrambling'] == 14)]['RT'])[1])}).
	    ...
	    \py{"{:.1e}".format(ttest_ind(data_ss1[(data_ss1['scrambling'] == 0) & (data_ss1['intensity'] == 100)]['RT'], data_ss1[(data_ss1['scrambling'] == 18)]['RT'])[1])}, \py{"{:.1e}".format(ttest_ind(data_ss1[(data_ss1['scrambling'] == 0) & (data_ss1['intensity'] == 100)]['RT'], data_ss1[(data_ss1['scrambling'] == 22)]['RT'])[1])}, and \py{"{:.1e}".format(ttest_ind(data_ss1[(data_ss1['scrambling'] == 0) & (data_ss1['intensity'] == 100)]['RT'], data_ss1[(data_ss1['scrambling'] == 26)]['RT'])[1])} respectively.
	    ...
	    \py{"{:.1e}".format(ttest_ind(data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 100)]['error rate'], data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 40)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 100)]['error rate'], data_ss3[(data_ss3['scrambling'] == 6)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 100)]['error rate'], data_ss3[(data_ss3['scrambling'] == 10)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 100)]['error rate'], data_ss3[(data_ss3['scrambling'] == 14)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 100)]['error rate'], data_ss3[(data_ss3['scrambling'] == 18)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 100)]['error rate'], data_ss3[(data_ss3['scrambling'] == 22)]['error rate'])[1]/2)}, and
	    \py{"{:.1e}".format(ttest_ind(data_ss3[(data_ss3['scrambling'] == 0) & (data_ss3['intensity'] == 100)]['error rate'], data_ss3[(data_ss3['scrambling'] == 26)]['error rate'])[1]/2)}
	...
	\subsection{Composite (Kernel-and-Cluster-Based) Scrambling}\label{sec:r_pe_cs}
	    ...
	    The data does seem to indicate an appropriate baseline for easy emotion recognition (namely visual recognition of pictures processed with a scrambling kernel of \SI{6}{\pixel} and a scrambling cluster of \SI{10}{\pixel}: two-tailed \textit{p} = \py{"{:.1e}".format(ttest_ind(data_cs2[(data_cs2['scrambling'] == 0) & (data_cs2['intensity'] == 100)]['RT'], data_cs2[(data_cs2['scrambling'] == 10)]['RT'])[1])}).
	    ...
	    (2-tailed \textit{p} of \py{"{:.1e}".format(ttest_ind(data_cs3[(data_cs3['scrambling'] == 0) & (data_cs3['intensity'] == 40)]['RT'], data_cs3[(data_cs3['scrambling'] == 11)]['RT'])[1])})
	    ...
	    (2-tailed \textit{p} of \py{"{:.1e}".format(ttest_ind(data_cs3[(data_cs3['scrambling'] == 0) & (data_cs3['intensity'] == 100)]['RT'], data_cs3[(data_cs3['scrambling'] == 23)]['RT'])[1])}).
	    ...
	    \py{"{:.1e}".format(ttest_ind(data_cs5[(data_cs5['scrambling'] == 0) & (data_cs5['intensity'] == 40)]['error rate'], data_cs5[(data_cs5['scrambling'] == 0) & (data_cs5['intensity'] == 100)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_cs5[(data_cs5['scrambling'] == 0) & (data_cs5['intensity'] == 40)]['error rate'], data_cs5[(data_cs5['scrambling'] == 11)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_cs5[(data_cs5['scrambling'] == 0) & (data_cs5['intensity'] == 40)]['error rate'], data_cs5[(data_cs5['scrambling'] == 15)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_cs5[(data_cs5['scrambling'] == 0) & (data_cs5['intensity'] == 40)]['error rate'], data_cs5[(data_cs5['scrambling'] == 19)]['error rate'])[1]/2)},
	    \py{"{:.1e}".format(ttest_ind(data_cs5[(data_cs5['scrambling'] == 0) & (data_cs5['intensity'] == 40)]['error rate'], data_cs5[(data_cs5['scrambling'] == 23)]['error rate'])[1]/2)}, and
	    \py{"{:.1e}".format(ttest_ind(data_cs5[(data_cs5['scrambling'] == 0) & (data_cs5['intensity'] == 40)]['error rate'], data_cs5[(data_cs5['scrambling'] == 27)]['error rate'])[1]/2)}
	    respectively).
